 ...
 * 应用的主模块
 * 定义angular模块对象变量app，该模块名称AceApp，且依赖一系列模块
 * 模块列表：
 * ngAnimate
 * ngResource
 * ngSanitize
 ...
 * oc.lazyLoad
 * ui.bootstrap
 * ui.router，由文件/components/angular-ui-router/release/angular-ui-router.js引入，用于路由
 * ace.directives，由文件/js/directives/ace.js引入，一些在模块ace.directives下的自定义的指令
 * ngStorage
 */
	...
	.config(function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider /**, cfpLoadingBarProvider*/ ) {
		...
		$stateProvider
			...
			.state('dashboard', {
				//路由地址
				url: '/dashboard',
				//标题，用于显示在页面标题中，菜单栏，导航条中
				title: '仪表板',
				//图标，表示显示在菜单项前面的图标，以及折叠后菜单栏的标签
				icon: 'fa fa-tachometer',
				//引用的模板html文件路径
				templateUrl: 'views/pages/dashboard.html',
				//设置路由对象的angular的控制器名称
